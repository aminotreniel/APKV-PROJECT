Shader "Unreal/MI_Bricks_Brick_01"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[2] = float4(0.410615,-0.410615,0.911809,5.000000);//(Unknown) (Unknown) (Unknown) Dirt_Amount
	Material.ScalarExpressions[3] = float4(0.500000,0.600000,0.000000,0.000000);//Roughness_Strength AO_Strength (Unknown) (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local12 = (Parameters.TexCoords[0].xy * Material.VectorExpressions[4].rg);
	MaterialFloat2 Local13 = ((MaterialFloat2(0.50000000,0.50000000) * -1.00000000) + Local12);
	MaterialFloat Local14 = dot(Local13, Material.VectorExpressions[5].rg);
	MaterialFloat Local15 = dot(Local13, Material.VectorExpressions[6].rg);
	MaterialFloat2 Local16 = (MaterialFloat2(0.50000000,0.50000000) + MaterialFloat2(Local14,Local15));
	MaterialFloat Local17 = MaterialStoreTexCoordScale(Parameters, Local16, 5);
	MaterialFloat4 Local18 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local16,View.MaterialTextureMipBias));
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 5);
	MaterialFloat Local20 = lerp(0.00000000,Local18.r,Material.ScalarExpressions[2].w);
	MaterialFloat3 Local21 = lerp(Local11,MaterialFloat3(1.00000000,1.00000000,1.00000000),MaterialFloat(Local20));
	MaterialFloat Local22 = MaterialStoreTexCoordScale(Parameters, Local0, 0);
	MaterialFloat4 Local23 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local24 = MaterialStoreTexSample(Parameters, Local23, 0);
	MaterialFloat Local25 = (Material.ScalarExpressions[3].x * Local23.g);
	MaterialFloat Local26 = (Material.ScalarExpressions[3].y * Local23.r);

	PixelMaterialInputs.EmissiveColor = Local5;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local21;
	PixelMaterialInputs.Metallic = Local23.b;
