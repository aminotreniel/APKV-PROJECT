...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,0.580000);//UVTiling Normal Intensity (Unknown) Brightnes
	Material.ScalarExpressions[1] = float4(0.000000,24.415461,0.000000,0.500000);//Metalic Roughness_Strength __SubsurfaceProfile AO_Strength
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local16 = (Local12.r * Material.ScalarExpressions[1].w);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.ScalarExpressions[1].z);
