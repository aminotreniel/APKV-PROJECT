...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,0.000000);//UVTiling Normal Intensity (Unknown) Lightness
	Material.ScalarExpressions[1] = float4(0.750000,0.000000,0.000000,0.000000);//Ambient Occlusion (Unknown) (Unknown) (Unknown)
}
MaterialFloat3 CustomExpression0(FMaterialPixelParameters Parameters,MaterialFloat In1,MaterialFloat3 In2)
{
return max(In1, In2)
;
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local9 = CustomExpression0(Parameters,Material.ScalarExpressions[0].w,Local7.rgb);
	...
	PixelMaterialInputs.AmbientOcclusion = Material.ScalarExpressions[1].x;
