...
public class VectorFieldEditor: Editor
{
	...
	// Import	
	SerializedProperty ImportFormat;
	...
	void OnEnable()
	{
		...
		// Import
		ImportFormat = serializedObject.FindProperty("ImportFormat");
	...
	public override void OnInspectorGUI()
	{
		...
		currentTab = GUILayout.Toolbar(currentTab, new string[] {"Bounds", "Intensity", "Size", "Gizmo", "Import"});
		...
		switch (currentTab)
		{
			...
			case 3:
				...
				break;
			case 4:	
				EditorGUILayout.PropertyField(ImportFormat);
				break;
		}
		GUILayout.EndVertical();
		serializedObject.ApplyModifiedProperties();
