...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,-2.000000,0.000000,3.000000);//UVTiling Normal Intensity (Unknown) Brightnes
	Material.ScalarExpressions[1] = float4(1.000000,2.200000,0.500000,0.000000);//Metalic Roughness_Strength AO_Strength (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local1 = MaterialStoreTexCoordScale(Parameters, Local0, 6);
	...
	MaterialFloat3 Local14 = (Material.ScalarExpressions[1].y * Local12.rgb);
	MaterialFloat Local15 = MaterialStoreTexCoordScale(Parameters, Local0, 4);
	MaterialFloat4 Local16 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local17 = MaterialStoreTexSample(Parameters, Local16, 4);
	MaterialFloat3 Local18 = (Local16.rgb * Material.ScalarExpressions[1].z);
