Shader "Unreal/MI_Garbige_00-18"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,1.000000);//UVTiling Normal Intensity (Unknown) Metalic
	Material.ScalarExpressions[1] = float4(0.850000,0.500000,0.000000,0.000000);//Roughness_Strength AO_Strength (Unknown) (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local13 = (Local11.b * Material.ScalarExpressions[0].w);
	MaterialFloat Local14 = (Material.ScalarExpressions[1].x * Local11.g);
	MaterialFloat Local15 = (Material.ScalarExpressions[1].y * Local11.r);
