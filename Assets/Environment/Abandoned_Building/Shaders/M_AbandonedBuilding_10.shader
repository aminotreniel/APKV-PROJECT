Shader "Unreal/MI_AbandonedBuilding_10"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[1] = float4(0.450000,0.000000,0.850000,0.500000);//Brightnes Metalic Roughness_Strength AO_Strength
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local14 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local0,View.MaterialTextureMipBias));
